...
#' `estimate_secondary()` (deprecated). This model is a combination of a convolution of
...
#' @seealso `estimate_secondary()` (deprecated)
#' @return A `<secondary_opts>` object of binary options summarising secondary
#' model used in `estimate_secondary()` (deprecated). Options returned are `cumulative`
