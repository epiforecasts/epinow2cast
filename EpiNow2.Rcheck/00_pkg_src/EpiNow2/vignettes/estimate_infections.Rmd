...
> **Note:** Since EpiNow2 v2.0.0, the package uses
> [epinowcast](https://package.epinowcast.org/) as its computational backend.
> The Gaussian process prior and back-calculation model described below are no
> longer available. The default model now uses a random walk prior for the
> reproduction number. The renewal equation and observation model sections
> remain accurate.
